...
/*: #define objBodyOut
      &Body |-> same , lBodyObj |-> same , lBodyProto |-> same */ "#define";

/*: #define tyPlanet [;L]
    [[]] / [objBodyIn] -> Ref(L) / [L |-> (_:tyBody, lBodyProto), objBodyOut] */ "#define";
...
/*: #define boilerPlateFrame
    [&this |-> _:Ref(L), L |-> (_:{(= v thisD)}, lNBodySystemProto),
     Lbodies |-> (_:{(= v aBodies)}, lArrayProto)] -> sameType */ "#define";
